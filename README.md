...
- サムネイルを**1回クリック**すると、その作品を選択します（複数選択して一括削除する場合などに使用）
- サムネイルを**ダブルクリック**すると、画像ビューワーを全画面表示で開きます
...
- 一覧からEnterキーまたはサムネイルクリックで開くと、右側にドッキング表示されます
- 右上のアイコンから全画面表示への切り替え、または元に戻すことができます
